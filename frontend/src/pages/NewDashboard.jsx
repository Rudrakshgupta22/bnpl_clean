      ...
      <div className="flex-1 flex flex-col overflow-hidden">
              ...
              <div className="flex items-center space-x-4">
                {activeSection === 'health' && (
                  <motion.button
                    ...
                    className="px-6 py-2 bg-gradient-to-r from-green-500 to-emerald-600 rounded-lg font-semibold hover:shadow-lg hover:shadow-green-500/50 transition"
                  >
                    ✏️ Edit Profile
                  </motion.button>
                )}
                ...
                <motion.button
                  ...
                  onClick={syncEmails}
                  disabled={syncing}
                  className="px-6 py-2 bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg font-semibold hover:shadow-lg hover:shadow-purple-500/50 transition disabled:opacity-50"
                >
        ...
        {message.text && (
          <motion.div
            ...
            className={`max-w-7xl mx-auto px-6 py-3 mt-4 rounded-lg ${
